...
public class CadastroAdmistradorDAO {
    ...
    public ArrayList<CadastroAdmistradorDTO> pesquisarAdmistrador(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                objAdmDTO.setIdadmistrador(rs.getInt("idadmistrador"));  
    ...
    public ArrayList<CadastroAdmistradorDTO> pesquisarAdmistradoresPorNome(String nome) throws Exception {
        ...
        while (rs.next()) {
            ...
            adm.setIdadmistrador(rs.getInt("idadmistrador"));
